...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const inviteLink = `https://discord.com/api/oauth2/authorize?client_id=${interaction.client.user.id}&permissions=${permissionsInt}&scope=bot%20applications.commands`;
